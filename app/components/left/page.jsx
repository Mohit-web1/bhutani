...
const Left = () => {
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0 border border-slate-400 p-3 rounded-lg">
      <Image src={Img} alt="img" height={100} width={100} layout='responsive' className='rounded-md' />
    </div>
